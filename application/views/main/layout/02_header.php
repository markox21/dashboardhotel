    ...
    <nav class="header-navbar navbar navbar-expand-lg align-items-center floating-nav navbar-light navbar-shadow container-xxl">
        <div class="navbar-container d-flex content">
            ...
            <ul class="nav navbar-nav align-items-center ms-auto">
                ...
                <li class="nav-item dropdown dropdown-notification me-25" id="container-notification">
                    <a class="nav-link" href="#" data-bs-toggle="dropdown" id="view-notification">
                    ...
                    <ul class="dropdown-menu dropdown-menu-media dropdown-menu-end">
                        <li class="dropdown-menu-header">
                            <div class="dropdown-header d-flex">
                                ...
                                <div class="badge rounded-pill badge-light-primary mx-1"><span id="new-notifications-count">0</span> Nuevos</div>
                            </div>
                        </li>
                        <li class="scrollable-container media-list p-1" id="notification-list">
                            <span class="">Hoy</span> <hr style="margin: 5px 0 5px 0;">
                            <div class="media-list pb-1" id="today-notification-list">
                            </div>
                            <span class="">Anteriores</span> <hr style="margin: 5px 0 5px 0;">
                            <div class="media-list pb-1" id="previous-notification-list">
                            </div>
                        </li>
                        <li class="dropdown-menu-footer">
                            <div class="list-item d-flex align-items-center">
                                <h6 class="fw-bolder me-auto mb-0">Notificación del sistema</h6>
                    ...
                    <ul class="dropdown-menu dropdown-menu-media dropdown-menu-end">
                        ...
                        <li class="scrollable-container media-list"><a class="d-flex" href="#">
                                <div class="list-item d-flex align-items-start">
                                    <div class="me-1">
                                        <div class="avatar"><img src="<?php echo BASE_URL ?>public/app-assets/images/portrait/small/avatar-s-15.jpg" alt="avatar" width="32" height="32"></div>
                                    </div>
                                ...
                                <div class="list-item d-flex align-items-start">
                                    <div class="me-1">
                                        <div class="avatar"><img src="<?php echo BASE_URL ?>public/app-assets/images/portrait/small/avatar-s-3.jpg" alt="avatar" width="32" height="32"></div>
                                    </div>
                                    <div class="list-item-body flex-grow-1">
